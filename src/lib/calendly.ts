...
If you'd prefer, reply with 2 to 3 times that suit you (include your timezone) and we'll book the slot for you and confirm by email.`;
  }
...
Prefer we schedule for you? Reply with 2 to 3 times that suit you (include your timezone) and we'll confirm by email.`;
}
