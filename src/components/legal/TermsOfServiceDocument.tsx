  ...
  return (
    <article className="space-y-6 text-cedar-mist">
      <header className="space-y-2 border-b border-white/10 pb-8">
        ...
        <h1 className="text-4xl font-display text-cedar-ivory">Terms of Service</h1>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">3. Eligibility</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">4. Our Services</h2>
        <h3 className="text-lg font-semibold text-cedar-ivory">4.1 Service Packages</h3>
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">4.2 Service Delivery</h3>
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">4.3 Client Responsibilities</h3>
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">4.4 Third-Party Services</h3>
        <p className="leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">5. Accounts and Registration</h2>
        <h3 className="text-lg font-semibold text-cedar-ivory">5.1 Creating an Account</h3>
        <p className="leading-relaxed">
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">5.2 Account Security</h3>
        <p className="leading-relaxed">
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">5.3 Identity verification</h3>
        <p className="leading-relaxed">
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">5.4 Account Suspension</h3>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">6. Payments and Fees</h2>
        <h3 className="text-lg font-semibold text-cedar-ivory">6.1 Payment Terms</h3>
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">6.2 Accepted Payment Methods</h3>
        <p className="leading-relaxed">
          We accept payment via bank transfer and online payment channels. Payment details will be provided in your invoice.
        </p>
        <h3 className="text-lg font-semibold text-cedar-ivory">6.3 Late Payments</h3>
        <p className="leading-relaxed">
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">6.4 Refunds</h3>
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">7. Intellectual Property</h2>
        <h3 className="text-lg font-semibold text-cedar-ivory">7.1 Your Content</h3>
        <p className="leading-relaxed">
          You retain ownership of all content, logos, images, and materials you provide to Cedarce for use in your project.
        </p>
        <h3 className="text-lg font-semibold text-cedar-ivory">7.2 Deliverables</h3>
        <p className="leading-relaxed">
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">7.3 Cedarce IP</h3>
        <p className="leading-relaxed">
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">7.4 Portfolio Rights</h3>
        <p className="leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">8. Confidentiality</h2>
        <p className="leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">9. Support and Maintenance</h2>
        <h3 className="text-lg font-semibold text-cedar-ivory">9.1 Post-Launch Support</h3>
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">9.2 Out-of-Scope Work</h3>
        <p className="leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">10. Limitation of Liability</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">11. Warranties and Disclaimers</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">12. Prohibited Use</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">13. Termination</h2>
        <h3 className="text-lg font-semibold text-cedar-ivory">13.1 By You</h3>
        <p className="leading-relaxed">
        ...
        <h3 className="text-lg font-semibold text-cedar-ivory">13.2 By Cedarce</h3>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">14. Governing Law and Dispute Resolution</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">15. Changes to These Terms</h2>
        <p className="leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-cedar-ivory">16. Contact Us</h2>
